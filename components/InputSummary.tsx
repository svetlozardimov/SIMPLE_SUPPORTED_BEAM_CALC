      ...
      >
        <div className="p-3 border-t border-slate-700 space-y-3">
          ...
          <div className="p-2 bg-slate-800 rounded-md">
            <h4 className="font-semibold text-cyan-400 mb-2 text-sm">Параметри на гредата</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="p-2 bg-slate-800 rounded-md">
              <h4 className="font-semibold text-cyan-400 mb-2 text-sm">Равномерни товари</h4>
              ...
              ) : <p className="text-xs text-slate-500">Няма.</p>}
            </div>
             <div className="p-2 bg-slate-800 rounded-md">
              <h4 className="font-semibold text-cyan-400 mb-2 text-sm">Концентрирани товари</h4>
              {pointLoads.length > 0 ? (
                <ul className="space-y-1 text-xs">
                  {pointLoads.map(load => (
                    <li key={load.id} className="font-mono text-slate-300">
